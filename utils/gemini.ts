...
const GEMINI_KEY =
  ...
  "AIzaSyCUbMOAmbOiVqKQPj1uYH9Pa3wF8hWyFN0";
const GEMINI_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_KEY}`;

// ✅ Fixed: only reference fields that actually exist in tollPlazas
...
export async function sendMessage(
  ...
  const contents = [
    ...
    {
      role: "model",
      parts: [{ text: "Sige, naiintindihan ko. Handa na akong tumulong!" }],
    },
