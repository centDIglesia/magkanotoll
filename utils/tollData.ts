...
export const tollPlazas: Record<string, Expressway> = {
  NLEX: {
    ...
    plazaList: [
      ...
      { name: "Marilao", coordinates: { lat: 14.7578, lng: 120.9575 } },
      {
        ...
        coordinates: { lat: 14.7958, lng: 120.9389 },
      },
  ...
  SCTEX: {
    ...
    plazaList: [
      ...
      { name: "Clark South", coordinates: { lat: 15.1575, lng: 120.5489 } },
      {
        ...
        coordinates: { lat: 15.2017, lng: 120.575 },
      },
  ...
  Skyway: {
    ...
    plazaList: [
      ...
      { name: "C-5", coordinates: { lat: 14.5167, lng: 121.0319 } },
      {
        ...
        coordinates: { lat: 14.5386, lng: 121.0183 },
      },
  ...
  CAVITEX: {
    ...
    plazaList: [
      ...
      { name: "Kawit", coordinates: { lat: 14.4414, lng: 120.9103 } },
      {
        ...
        coordinates: { lat: 14.4817, lng: 120.9892 },
      },
      {
        name: "C5 Rd. Ext./C.P. Garcia",
        coordinates: { lat: 14.4828, lng: 120.9867 },
      },
    ],
  },
  ...
  MCX: {
    ...
    plazaList: [
      {
        name: "SLEX (Susana Heights)",
        coordinates: { lat: 14.3828, lng: 121.0442 },
      },
  ...
  NAIAX: {
    ...
    plazaList: [
      { name: "Skyway", coordinates: { lat: 14.5244, lng: 121.0139 } },
      {
        ...
        coordinates: { lat: 14.5231, lng: 121.0167 },
      },
      {
        name: "Aurora Blvd. (Tramo)",
        coordinates: { lat: 14.5283, lng: 121.0039 },
      },
      ...
      { name: "NAIA Terminal 2", coordinates: { lat: 14.5092, lng: 121.0078 } },
      {
        ...
        coordinates: { lat: 14.5186, lng: 120.9889 },
      },
  ...
  NLEX_Connector: {
    ...
    plazaList: [
      ...
      { name: "Magsaysay", coordinates: { lat: 14.6025, lng: 121.0022 } },
      {
        ...
        coordinates: { lat: 14.6431, lng: 120.9814 },
      },
    ],
  },
    ...
    plazaList: [
      {
        ...
        coordinates: { lat: 14.6833, lng: 120.9781 },
      },
      {
        name: "C-3 Road/5th Ave.",
        coordinates: { lat: 14.6431, lng: 120.9814 },
      },
      {
        ...
        coordinates: { lat: 14.6533, lng: 120.9639 },
      },
      {
        name: "R-10/Port of Manila",
        coordinates: { lat: 14.6347, lng: 120.9572 },
      },
      {
        name: "Harbor Link Interchange",
        coordinates: { lat: 14.6586, lng: 120.9744 },
      },
    ],
  },
};
...
export async function getDrivingRouteBetweenPlazas(fromPlaza: string, toPlaza: string) {
